...
\begin{itemize}
	...
	\item L'algorithme de backpropagation
...
%%%%%%%%% PAGE 12 : Annexe - Python %%%%%%%%%

\begin{frame}{Annexes: Code python}
...
class Net(nn):
	def \_\_init\_\_(self, dim\_in, dim\_out):
		super().\_\_init\_\_(self)
		\#
		self.layer = nn.Linear(dim\_in, dim\_out)
...
%%%%%%%%% PAGE 13 : Annexe - L'algorithme de backpropagation %%%%%%%%%

\begin{frame}{Annexes: L'algorithme de backpropagation}
...
%%%%%%%%% PAGE 14 : Annexe - Fonction de loss %%%%%%%%%
...
%%%%%%%%% PAGE 15 : Annexe - Comparaison avec le modème GPT %%%%%%%%%
...
%%%%%%%%% PAGE 16 : Annexe - Le théorème d'approximation universel %%%%%%%%%
